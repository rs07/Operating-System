...
myfs>cp osfile3 C:testfile1 /* copy the file osfile3 from os to the filesystem C: as testfile1 */

myfs>ls C: /* see the contents of the filesystem C: */
testfile1 ... size

myfs>cp C:testfile1 C:testfile1a /* copy the file testfile1 from C: to the filesystem C: as testfile1a */

myfs>ls C: /* see the contents of the filesystem C: */
testfile1 ... size
testfile1a ... size

myfs>cp C:testfile1 D:testfile2 /* copy the file testfile1 from C: to the filesystem D: as testfile2 */
...
File System on File - How it shows!
